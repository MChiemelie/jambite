  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button
          type='button'
          className='inline-flex items-center justify-center gap-2 px-3 py-2 rounded bg-blue-50 border border-blue-200 text-sm font-medium hover:bg-blue-100 transition-colors'
        ...
        <div className='flex flex-col gap-2'>
          <div className='flex items-center gap-3 justify-center p-3 bg-blue-50 rounded-lg'>
            ...
            <p className='text-sm text-gray-700'>
              Quick keyboard guide for navigating the practice screen.
            </p>
          </div>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <div className='flex items-center gap-3 py-2'>
              <div className='flex gap-1'>
                <kbd className='px-2 py-1 bg-white border border-gray-300 rounded shadow-sm text-xs font-mono font-semibold min-w-[28px] text-center'>
                  A
                </kbd>
                <kbd className='px-2 py-1 bg-white border border-gray-300 rounded shadow-sm text-xs font-mono font-semibold min-w-[28px] text-center'>
                  B
