    ...
    <nav className='fixed top-0 flex items-center justify-between z-20 w-full p-2 md:p-4'>
      ...
      <div className='flex gap-4 items-center'>
        ...
        <Link href='/sign-in' className='p-[0.1rem] relative z-20'>
          ...
          <Link
            href={'/sign-in'}
            className='rounded flex items-center justify-center gap-2 px-4 py-[.45rem] relative bg-background text-foreground hover:bg-transparent hover:text-white text-xs font-medium'
          >
            <span>Sign In</span>
