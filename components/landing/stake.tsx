      ...
      <div className="relative overflow-hidden rounded shadow-lg">
        ...
        <div className="relative z-10 flex flex-col justify-around gap-8 p-2 sm:p-6 md:flex-row">
          <div className="flex flex-col gap-4">
            <h2 className="text-center text-2xl font-semibold text-sky-50 text-shadow-gray-800 text-shadow-xs sm:text-3xl">
          ...
          <Image
            ...
            className="border-foreground/10 w-full rounded border-2 md:w-1/2"
          />
        </div>
      </div>
    </section>
