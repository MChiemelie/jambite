  ...
  return (
    <div className='bg-muted/50 flex w-full flex-col justify-between gap-4 rounded p-4 md:min-h-full'>
      <div className='flex items-center justify-between'>
        ...
        <button onClick={() => setCurrentIndex((prev) => Math.max(prev - 1, 0))} disabled={currentIndex === 0} className={`flex items-center gap-2 font-semibold ${currentIndex === 0 ? 'text-gray-400' : 'text-blue-500'}`} aria-label='Next word' type='button'>
