          ...
          <table className='w-full table-auto'>
            ...
            <tbody>
              {Object.keys(unattemptedQuestions).map((subject) => (
                <tr key={subject}>
                  <td className='border px-2 py-1 md:px-4 lg:py-2 text-xs sm:text-sm md:text-base font-semibold'>
                    {subject}
                  </td>
                  <td className='border px-2 py-1 md:px-4 lg:py-2 text-xs sm:text-sm md:text-base text-center'>
