...
export default function HeroSection() {
  ...
  return (
    <div ref={ref} className="flex  md:min-h-[200vh] shrink-0 scale-[.30] xs:scale-[.35] sm:scale-[.65] transform flex-col items-center justify-start [perspective:800px] md:scale-100 md:py-48">
