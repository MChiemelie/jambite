    ...
    <div className='flex min-h-screen'>
      ...
      <div className='relative flex w-full items-center justify-center md:w-1/2'>
        ...
        <section className='bg-muted/50 flex h-fit w-5/6 flex-col items-center gap-4 rounded-md p-4 sm:w-4/5 sm:p-8'>
          <Image src='/images/special/logo/1.png' alt='Jambite Logo' width={100} height={100} className='mx-auto max-w-[80px]' priority />
          {children}
          <div className='mx-auto flex items-center'>
            <div className='border-foreground/20 max-w-20 min-w-10 flex-grow border' />
            <span className='text-foreground/80 px-2 text-xs whitespace-nowrap'>continue with</span>
            <div className='border-foreground/20 max-w-20 min-w-10 flex-grow border' />
          </div>
