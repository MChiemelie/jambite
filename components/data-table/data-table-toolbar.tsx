        ...
        case 'number':
          return (
            <div className="relative">
              ...
              {columnMeta.unit && <span className="absolute top-0 right-0 bottom-0 flex items-center rounded-r-md bg-accent px-2 text-muted-foreground text-sm">{columnMeta.unit}</span>}
            </div>
          );
