    ...
    case 'correct':
      return (
        <p className='text-md md:text-lg'>
          You are Correct! <ThumbsUp className='inline w-4 h-4' /> The answer is{' '}
          {fb.correctAnswer} <Check className='inline w-4 h-4 text-green-600' />
          .
        </p>
      );
    case 'incorrect':
      return (
        <p className='text-md md:text-lg'>
          <X className='inline w-4 h-4 text-red-600' /> {fb.userAnswer} is
    ...
    case 'unattempted':
      return (
        <p className='text-md md:text-lg'>
          ...
          <X className='inline w-4 h-4 text-red-600' />. The correct answer is{' '}
          {fb.correctAnswer} <Check className='inline w-4 h-4 text-green-600' />
          .
        </p>
      );
