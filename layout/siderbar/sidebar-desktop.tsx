...
export function SidebarDesktop({ sidebarItems }: SidebarDesktopProps) {
  ...
  return (
    <aside className="w-[240px] max-w-xs h-screen fixed left-0 top-0 z-40 border-r">
      <div className="h-full px-3 py-4">
        <h3 className="mx-3 text-lg font-semibold text-foreground">Jambite</h3>
        <div className="mt-5">
              ...
              <PopoverContent className="mb-2 w-56 p-3 rounded-[1rem]">
                <div className="space-y-1">
                  ...
                  <SidebarButton size="sm" icon={LogOut} className="w-full">
                    <form action="/auth/signout">Log Out</form>
                  </SidebarButton>
                </div>
              </PopoverContent>
            </Popover>
