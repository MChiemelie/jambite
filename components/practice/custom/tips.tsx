  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button
          type="button"
          className="inline-flex items-center justify-center gap-2 rounded border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-medium transition-colors hover:bg-blue-100"
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 py-2">
              <div className="flex gap-1">
                <kbd className="min-w-[28px] rounded border border-gray-300 bg-white px-2 py-1 text-center font-mono text-xs font-semibold shadow-sm">
                  A
                </kbd>
                <kbd className="min-w-[28px] rounded border border-gray-300 bg-white px-2 py-1 text-center font-mono text-xs font-semibold shadow-sm">
                  B
