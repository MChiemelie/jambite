...
export const MacbookScroll = ({ src, showGradient, title, badge }: { src?: string; showGradient?: boolean; title?: string | React.ReactNode; badge?: React.ReactNode }) => {
  ...
  return (
    <div ref={ref} className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-80">
      <motion.h2
        ...
        className="mb-20 text-center text-8xl font-extrabold text-neutral-800 dark:text-white"
      >
        Ace JAMB with <br/> AI-assisted CBT Practice
      </motion.h2>
      {/* Lid */}
