...
function Value({
  ...
  return (
    <div
      className={cn(
        'flex flex-col md:flex-row items-center mx-auto gap-4 md:gap-20',
        reverse
      )}
    >
      <div className='md:max-w-lg flex flex-col gap-2 md:gap-4'>
        <h3 className='text-md md:text-lg lg:text-xl text-center uppercase font-semibold bg-gradient-to-r from-blue-800 to-indigo-900 bg-clip-text text-transparent dark:bg-gradient-to-r dark:from-sky-400 dark:via-blue-500 dark:to-cyan-400 dark:bg-clip-text dark:text-transparent'>
          {heading}
        </h3>
      ...
      <div className='relative w-[90%] md:w-[70%] max-w-lg mx-auto aspect-video'>
        <div
          className={cn(
            'absolute top-5 left-5 w-[4/5] h-full rounded rotate-[-2.5deg] z-0 inset-0 shadow-xl transform-gpu rotate-y-[0.05deg] transition-transform duration-2000 ease-in-out will-change-transform hover:translate-x-1 hover:translate-y-2',
            gradient
          )}
        />
        <div className='relative z-0 rounded overflow-hidden shadow-2xl'>
          <video
            ...
            preload='auto'
            muted
            className='bg-muted/80 w-full h-full transform-gpu perspective-[800px] rotate-y-[0.05deg] transition-transform duration-2000 ease-in-out will-change-transform '
          >
            <track
