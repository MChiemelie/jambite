...
export default function HeroSection() {
  ...
  return (
    <div ref={ref} className="flex min-h-[80vh] sm:min-h-[200vh]  md:min-h-[250vh] shrink-0 scale-[.30] xs:scale-[.35] sm:scale-[.65] transform flex-col items-center justify-start [perspective:800px] md:scale-100 md:py-48">
      <section className="p-4 -mt-60 xs:-mt-40 sm:-mt-20 md:-mt-10 scale-200 sm:scale-none pb-40 sm:pb-0 flex flex-col sm:gap-8 gap-4 md:gap-4 max-w-3xl">
        ...
        <motion.p style={{ translateY: textTransform, opacity: textOpacity }} className="text-center text-xl md:text-base md:text-sky-50 lg:text-shadow-sm text-shadow-xs text-shadow-gray-800">
